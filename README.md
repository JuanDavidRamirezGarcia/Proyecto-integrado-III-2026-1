...
* Puntaje de encarecimiento: Esta métrica mide el índice de encarecimiento acumulado. Asignando a todos los países un puntaje base de 100 puntos y comparando los precios a través del tiempo.
Puntaje=(Price−USD−actualPrice−USD−octubre−2025)∗100

* Variación del costo de la canasta familiar: Esta métrica nos mostrará el porcentaje total de encarecimiento de los productos de la canasta básica.
variacion=(Breakfast−Basket−Marzo2026−Breakfast−Basket−Octubre2025Breakfast−Basket−Octubre2025)∗100

* Diferencia del costo de la canasta en dolares= En esta variable se va a comparar el costo en dólares de la canasta básica con el promedio de los países de Latinoamérica.
Brecha (USD)=Breakfast-Basket-USDColombia−Promedio-Basket-USDLatam
